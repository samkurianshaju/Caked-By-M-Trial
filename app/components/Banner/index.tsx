                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        <Fade direction={'up'} delay={400} cascade damping={1e-1} triggerOnce={true}>
                            <h1 className="text-4xl lg:text-7xl font-semibold mb-5 text-lightgrey md:4px lg:text-start text-center">
                                We are here <br /> with best cakes
                            </h1>
                        </Fade>
                        <Fade direction={'up'} delay={800} cascade damping={1e-1} triggerOnce={true}>
                            <p className='text-grey lg:text-lg font-normal mb-10 lg:text-start text-center'>What ever the occasion it is we are here with the varieties. <br /> Connect us! We will make your day Delicious</p>
                        </Fade>
                    ...
                    <div className='col-span-6 flex justify-center relative'>
                        <div className='flex bg-white p-2 gap-5 items-center bottom-10 left-10 rounded-xl absolute'>
                            <Image src={'/images/Banner/bnl1.png'} alt="cake-image" width={68} height={68} />
                            <p className='text-lg font-normal'>More than 200+ <br /> recipes.</p>
                        </div>
                        <Image src="/images/Banner/bn1.png" alt="nothing" width={1000} height={1000} />
                    </div>
                </div>
            </div>
        </div>
